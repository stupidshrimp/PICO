...
| Altitude-hold degraded paths | all fall back to level pitch | No target captured (unusable barometer at engage), barometer failing in flight, stale pitot, or airspeed below the floor. The orbit itself continues in every case; only the hold is abandoned |
