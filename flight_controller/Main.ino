...
// ----- CRSF diagnostics -----
// Disabled by default because the once-per-second USB Serial report is large
// enough to block the flight loop if the host or TX buffer cannot keep up.
// Enable only for bench telemetry debugging by compiling with
// -DCRSF_DIAGNOSTICS_ENABLED=1 or by temporarily changing the default below.
#ifndef CRSF_DIAGNOSTICS_ENABLED
#define CRSF_DIAGNOSTICS_ENABLED 0
#endif
