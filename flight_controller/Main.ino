...
// The MagCalFlashRecord layout, the MAG_CAL_FLASH_* constants, and the
// MagCalSaveStatus enum live in mag_cal_flash.h (included at the top of this
// sketch) so they are declared ahead of the Arduino build's auto-generated
// function prototypes; see that header for the two-slot design notes.
