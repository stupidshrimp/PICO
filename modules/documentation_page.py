...
class DocumentationPage:
    ...
    def _populate_gcs_tab(self, layout: QVBoxLayout) -> None:
        ...
        overview = (
            ...
            "telemetry analytics, debug feeds, and this documentation."
        )
        ...
        self._add_subsection(
            ...
            (
                ...
                "Analytics pages: dedicated stacked widgets for telemetry graphs and debug stream inspection.",
            ),
        )
    ...
    def _populate_elrs_tab(self, layout: QVBoxLayout) -> None:
        ...
        self._add_subsection(
            ...
            (
                ...
                "Telemetry aggregator → GUI bindings → operator alerting",
            ),
        )
    ...
    def _build_aeroscout_text(self) -> str:
        return (
            ...
            "comparative post-flight analysis.</li>"
